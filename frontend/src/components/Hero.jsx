                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center py-16 px-6 lg:px-12">
                    <div className='text-gray-800 max-w-lg'>
                        ...
                        <div className='flex flex-col sm:flex-row gap-4'>
                            <Link 
                                to="/collection" 
                                className='bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-full font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300 text-center'
                            >
                                Explore Collection
                            </Link>
                            <Link 
                                to="/about" 
                                className='border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-full font-semibold hover:border-gray-400 hover:bg-gray-50 transition-all duration-300 text-center'
                            >
                                Learn More
                            </Link>
                        </div>
