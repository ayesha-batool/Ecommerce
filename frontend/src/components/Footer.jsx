            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
                            Discover your perfect style with our curated collection of premium fashion pieces. 
                            We blend timeless elegance with modern trends to help you express your unique personality.
                        </p>
                        <div className="flex space-x-4">
                            <div className="bg-gray-800 p-3 rounded-full hover:bg-blue-600 transition-colors cursor-pointer">
                ...
                <div className="mt-12 pt-8 border-t border-gray-800">
                    <div className="max-w-md">
                        ...
                        <p className="text-gray-300 mb-4">Subscribe to our newsletter for the latest fashion trends and exclusive offers.</p>
                        <div className="flex">
                            <input 
                                type="email" 
